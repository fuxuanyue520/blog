...
这是一个基于 [Astro](https://astro.build/) 构建的现代化个人技术博客。设计理念源于“秋兰以为佩”，追求简约、深邃与沉浸式的阅读体验。项目采用响应式设计，完美适配桌面端与移动端，并内置了丰富的功能模块，适合用于记录技术心得、生活感悟和项目展示。
